...
internal sealed interface SignUpInternalRoute {
    data class OnEmailChanged(val value: String) : SignUpInternalRoute
    data class OnPasswordChanged(val value: String) : SignUpInternalRoute
    data class OnConfirmPasswordChanged(val value: String) : SignUpInternalRoute
