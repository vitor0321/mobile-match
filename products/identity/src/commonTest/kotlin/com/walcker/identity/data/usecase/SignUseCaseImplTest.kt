...
class SignUseCaseImplTest {
    ...
    @Test
    fun `When observeSession should delegate to authRepository`() = runTest {
    ...
    @Test
    fun `When signInWithEmail should delegate to authRepository and return result`() = runTest {
    ...
    @Test
    fun `When signInWithGoogle should delegate to authRepository and return result`() = runTest {
    ...
    @Test
    fun `When signInWithApple should delegate to authRepository and return result`() = runTest {
    ...
    @Test
    fun `When signUp should delegate to authRepository and return result`() = runTest {
    ...
    @Test
    fun `When deleteAccount should delegate to authRepository and return result`() = runTest {
    ...
    @Test
    fun `When signOut should delegate to authRepository and return result`() = runTest {
    ...
    @Test
    fun `When sendPasswordResetEmail should delegate to authRepository and return result`() = runTest {
