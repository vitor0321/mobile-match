...
class BillingRepositoryImplTest {
    ...
    @Test
    fun `When listing offerings should return immutable offerings from billing client`() = runTest {
        val repository = BillingRepositoryImpl(
    ...
    @Test
    fun `When purchase succeeds should return Unit then delegate package id to billing client`() = runTest {
    ...
    @Test
    fun `When restore returns pro access should propagate true then delegate to billing client`() = runTest {
    ...
    @Test
    fun `When restore returns no pro access should propagate false`() = runTest {
    ...
    @Test
    fun `When management url is requested should delegate to billing client then return same value`() = runTest {
    ...
    @Test
    fun `When billing client fails with purchase error should keep mapped failure then repository exposes same domain error`() = runTest {
        val repository = BillingRepositoryImpl(
            billingClient = FakeBillingClient(
