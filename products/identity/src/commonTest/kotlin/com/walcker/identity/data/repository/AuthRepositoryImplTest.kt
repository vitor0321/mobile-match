...
class AuthRepositoryImplTest {
    ...
    @Test
    fun `When observing currentUser should delegate to firebaseAuth`() = runTest {
    ...
    @Test
    fun `When signIn should delegate to firebaseAuth and return result`() = runTest {
    ...
    @Test
    fun `When signInWithGoogle should delegate to googleAuth and return result`() = runTest {
    ...
    @Test
    fun `When signInWithApple should delegate to appleAuth and return result`() = runTest {
    ...
    @Test
    fun `When signUp should delegate to firebaseAuth and return result`() = runTest {
    ...
    @Test
    fun `When deleteAccount should delegate to firebaseAuth and return result`() = runTest {
    ...
    @Test
    fun `When signOut should delegate to firebaseAuth and return result`() = runTest {
    ...
    @Test
    fun `When sendPasswordResetEmail should delegate to firebaseAuth and return result`() = runTest {
