...
class GetMyMatchesUseCaseTest {
    ...
    @Test
    fun `partida em andamento fica em ativas`() =
        runTest {
    ...
    @Test
    fun `partida vira passada no instante em que acaba`() =
        runTest {
    ...
    @Test
    fun `cancelada e passada mesmo antes do horario`() =
        runTest {
            repository.myMatches =
                Result.success(
    ...
    @Test
    fun `separa as duas listas preservando a ordem de entrada`() =
        runTest {
            repository.myMatches =
                Result.success(
                    listOf(
    ...
    @Test
    fun `falha do repositorio sobe sem virar lista vazia`() =
        runTest {
