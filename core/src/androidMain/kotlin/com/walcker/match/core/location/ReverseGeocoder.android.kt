...
private class AndroidReverseGeocoder(application: Application) : ReverseGeocoder {
    ...
    private suspend fun fetchAddressModern(lat: Double, lng: Double): Address? =
    ...
    private suspend fun fetchAddressLegacy(lat: Double, lng: Double): Address? =
